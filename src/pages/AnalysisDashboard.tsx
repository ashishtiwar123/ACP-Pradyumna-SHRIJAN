...
import { Download, AlertTriangle, CheckCircle2, TrendingUp, Users, Target, ArrowLeft, Loader2, DollarSign, ChevronDown } from "lucide-react";
import { toast } from "sonner";
import { supabase } from "@/integrations/supabase/client";
import { useAuth } from "@/hooks/useAuth";
import { exportToPDF } from "@/lib/pdf-export";
import { exportToExcel } from "@/lib/excel-export";
import { processApiAnalysisData } from "@/lib/data-processing";
...
const AnalysisDashboard = () => {
  ...
  const handleExport = (format: string) => {
    ...
    try {
      // Process the analysis data to ensure proper format
      const processedData = processApiAnalysisData(analysis);
